# 📑 Índice de Documentação - Exercícios de Sockets (TCP + UDP)
...
| **[ChatUdpPeer.java](src/main/java/br/com/projeto/udp/ChatUdpPeer.java)** | ~160 | Chat UDP P2P (peer) |
| **[ChatMensagem.java](src/main/java/br/com/projeto/udp/ChatMensagem.java)** | ~30 | Modelo de mensagem (UDP) |
| **[ChatMensagemCodec.java](src/main/java/br/com/projeto/udp/ChatMensagemCodec.java)** | ~80 | Codec de mensagem (nome|texto) |
